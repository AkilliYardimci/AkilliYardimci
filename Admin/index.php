  ...
  <div class="container">
    <div class="col-left">
      <div class="login-text">
        ...
        <p>Panele Erişmek İçin Giriş Yapın</p>
    ...
    <div class="col-right">
      <div class="login-form">
        <h2>Giriş Yap</h2>
        <form method="POST" name="basket" action="login.php">
          <p>
            <label>Kullanıcı Adı<span>*</span></label>
            <input type="text" name="kadi" placeholder="" required>
          </p>
          <p>
          ...
          <p>
            <input type="submit"  name="basket" value="Giriş Yap" />
          </p>
        </form>
      </div>
    </div>
